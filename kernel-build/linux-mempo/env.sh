...
# deterministic build:
export KERNEL_DATE='2014-04-25 00:10:00' # UTC time of mempo version. This is > then max(kernel,grsec,patches) times
# Nothing up my sleeve number, unknown in advance even to me in a provable way - e.g. bitcoin markel root of recent block. 
export CURRENT_SEED='222c62a60869017e00664073dfdf9b0af18d28ac380f236ad9b6eb46547d759d' # from newest (at release, -6 blocks) http://blockchain.info/block-index/ or http://blockexplorer.com/
